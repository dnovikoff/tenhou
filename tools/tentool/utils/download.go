...
func (d *downloader) DownloadString(ctx context.Context, u string, opts ...Option) (string, error) {
	var buf bytes.Buffer
	err := NewDownloader(opts...).Write(ctx, u, &buf)
